...
./inPhynite --nt_init 128.0 --nt_log_slope -1.0 --n 40 --rooted 0 --n_global_iters 10000 --n_tree_iters 10000 --sample_every 10 --infer_nt 1 --out_dir /Users/ispecht/Desktop/PhyloSMC-analyses/runs/PhyloSMC/inferred_N_eff/drift_-1

# Inferred nt, constant 32
./inPhynite --nt_init 32.0 --nt_log_slope 0.0 --n 40 --rooted 0 --n_global_iters 10000 --n_tree_iters 10000 --sample_every 10 --infer_nt 1 --out_dir /Users/ispecht/Desktop/PhyloSMC-analyses/runs/PhyloSMC/inferred_N_eff/drift_0
